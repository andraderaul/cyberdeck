...
const VARIANT_CLASSES = {
  primary: 'border-2 border-accent bg-accent-bg text-accent font-bold',
  secondary: 'border border-info bg-info-bg text-info font-medium',
  danger: 'border border-danger bg-danger-ghost text-danger font-bold',
  record: 'border border-danger bg-transparent text-danger font-medium',
  analyze: 'border border-accent bg-accent-ghost text-accent',
