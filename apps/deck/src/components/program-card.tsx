...
export default function ProgramCard({ program }: Props) {
  return (
    <li>
      <a
        href={program.url}
        className="group flex h-full flex-col gap-item rounded-xs border border-base bg-bg-surface p-group transition-colors duration-fast hover:border-strong hover:bg-bg-elevated focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2 sm:p-stack"
      >
        <div className="flex items-baseline gap-item">
          ...
          <span className="ml-auto shrink-0 rounded-pill border border-subtle px-tight py-tight text-fg-subtle text-xs uppercase tracking-widest">
            {program.kind}
          </span>
        </div>
        ...
        <span className="mt-auto flex items-center gap-tight pt-item text-link text-xs tracking-wide">
          open
          <span
            aria-hidden="true"
