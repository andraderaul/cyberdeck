 ...
 * drive it from outside. Copied by hand from GLITCH//Studio (ADR 0011) as the second proven caller;
 * an extraction candidate for a later batch, per ADR 0016's convergence.
 */
  ...
  return (
    <div className="flex flex-col gap-md">
      <Button
        ...
        // is a dangling one for assistive tech.
