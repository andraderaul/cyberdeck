 ...
 * thumbnails are too, and keying them on the element lets them survive the PRESETS panel
 ...
 * stream (`snapshotSource`) — the alternative is one extra conversion per Preset every 15th of a
 * second, for a row that is being *looked at* rather than filmed.
 */
